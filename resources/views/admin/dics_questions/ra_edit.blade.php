      ...
      <div class="col-xl-12">
        ...
        <div class="m-portlet m-portlet--bordered-semi m-portlet--full-height ">
          ...
          <div class="m-portlet__body">
            <form method="post" action="{{ route('ra_question.update',['DiscQuestion'=>$DiscQuestion->slug]) }}" enctype="multipart/form-data">

                    <input type='hidden' name='_token' value="{!! csrf_token() !!}">
                    <div class="row">
                      <div class="form-group col-md-12">
                          <label>السوال</label>
                          <input type="text" name="content_ar" class="form-control" value="{{$DiscQuestion->content_ar}}">
                      </div>
                      <div class="form-group col-md-12">
                          <label>question</label>
                          <input type="text" name="content_en" class="form-control" value="{{$DiscQuestion->content_en}}">
                      </div>
