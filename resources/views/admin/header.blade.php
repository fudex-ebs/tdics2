                        ...
                        <ul class="m-nav m-nav--skin-light">
                          ...
                          <li class="m-nav__item">
                            <a href="#" class="m-nav__link">
                              <span class="m-nav__link-icon">
                                <img class="m-topbar__language-img" src="/metronic/assets/app/media/img/flags/015-china.svg">
                              </span>
                          ...
                          <li class="m-nav__item">
                            <a href="#" class="m-nav__link">
                              <span class="m-nav__link-icon">
                                <img class="m-topbar__language-img" src="/metronic/assets/app/media/img/flags/016-spain.svg">
                              </span>
                          ...
                          <li class="m-nav__item">
                            <a href="#" class="m-nav__link">
                              <span class="m-nav__link-icon">
                                <img class="m-topbar__language-img" src="/metronic/assets/app/media/img/flags/014-japan.svg">
                              </span>
                          ...
                          <li class="m-nav__item">
                            <a href="#" class="m-nav__link">
                              <span class="m-nav__link-icon">
                                <img class="m-topbar__language-img" src="/metronic/assets/app/media/img/flags/017-germany.svg">
                              </span>
