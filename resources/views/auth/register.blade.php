        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('messages.register') }}</div>
                    <div class="card-body"  style="display:block;" id="selectRole">
                        <div class="form-group row mb-0">
                            <div class="col-md-4 offset-md-2">
                                <a href="javascript:void(0);" class="addRole" data-role="individual">
                                    {{ __('messages.personal_account') }}</a>
                            </div>
                            <div class="col-md-4">
                                <a href="javascript:void(0);" class="addRole" data-role="company">
                                    {{ __('messages.company_account') }}
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body" style="display:none;" id="viewForm">
